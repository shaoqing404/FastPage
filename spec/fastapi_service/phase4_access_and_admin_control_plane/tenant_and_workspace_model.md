...
- `Tenant` in [app/models/tenant.py](app/models/tenant.py)
- `User` in [app/models/user.py](app/models/user.py)
- `ApiKey` in [app/models/api_key.py](app/models/api_key.py)
- `ModelProvider` in [app/models/model_provider.py](app/models/model_provider.py)
- `Document` in [app/models/document.py](app/models/document.py)
- `ChatSkill` in [app/models/chat_skill.py](app/models/chat_skill.py)
- `ChatSession` and `ChatMessage` in [app/models/chat_session.py](app/models/chat_session.py)
- `ChatRun` in [app/models/chat_run.py](app/models/chat_run.py)
- `ParseJob` in [app/models/parse_job.py](app/models/parse_job.py)

Service and router code generally enforce tenant-bounded reads and writes:

- documents filter on `current_user.tenant_id` in [app/api/routers/documents.py](app/api/routers/documents.py)
- jobs filter on `current_user.tenant_id` in [app/api/routers/jobs.py](app/api/routers/jobs.py)
- skills filter on `current_user.tenant_id` in [app/api/routers/skills.py](app/api/routers/skills.py)
- runs and sessions filter on principal tenant in [app/api/routers/chat.py](app/api/routers/chat.py)
- provider CRUD is tenant-scoped in [app/services/provider_service.py](app/services/provider_service.py)
- overview metrics aggregate by tenant in [app/api/routers/metrics.py](app/api/routers/metrics.py)
...
- see [app/services/storage_service.py](app/services/storage_service.py)
...
[app/core/bootstrap.py](app/core/bootstrap.py) currently:
...
[app/core/auth.py](app/core/auth.py) currently:
...
[app/core/principal.py](app/core/principal.py) currently contains:
...
`User` in [app/models/user.py](app/models/user.py) has a required `tenant_id`.
...
[app/services/session_service.py](app/services/session_service.py) currently lists sessions by:
...
[app/services/provider_service.py](app/services/provider_service.py) currently resolves providers in this order:
...
- [app/api/routers/documents.py](app/api/routers/documents.py)
- [app/api/routers/skills.py](app/api/routers/skills.py)
- [app/api/routers/chat.py](app/api/routers/chat.py)
- [app/api/routers/providers.py](app/api/routers/providers.py)
...
This keeps [app/api/deps.py](app/api/deps.py) stable while allowing the rest of the application to rely on one resolved context object.
...
[app/core/auth.py](app/core/auth.py) should stop using the global admin credential pair as the only accepted login.
...
[app/core/bootstrap.py](app/core/bootstrap.py) must be adjusted without breaking existing local/dev installs.
...
- [app/core/principal.py](app/core/principal.py)
...
- [app/models/tenant.py](app/models/tenant.py)
- [app/models/user.py](app/models/user.py)
- [app/models/api_key.py](app/models/api_key.py)
- [app/models/model_provider.py](app/models/model_provider.py)
- [app/models/document.py](app/models/document.py)
- [app/models/chat_skill.py](app/models/chat_skill.py)
- [app/models/chat_session.py](app/models/chat_session.py)
- [app/models/chat_run.py](app/models/chat_run.py)
- [app/models/parse_job.py](app/models/parse_job.py)
...
- [app/services/provider_service.py](app/services/provider_service.py)
- [app/services/document_service.py](app/services/document_service.py)
- [app/services/skill_service.py](app/services/skill_service.py)
